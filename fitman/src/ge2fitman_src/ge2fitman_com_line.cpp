...
/*****************************************************************************
 ...
 -8 - Invalid -ecc/-quality/-quecc parameter.
 ...
 >ge2fitman [general_opt] in_file [in_file_opt] ref_file [ref_file_opt] out_file
 ******************************************************************************/
...
void undo_ecc(Preprocess *preprocess, int *fid) {
    ...
    *fid = 0;
    preprocess[0].ecc_present = false;
    preprocess[1].ecc_present = false;        
    preprocess[0].pre_ecc = NO;    
    preprocess[1].pre_ecc = NO;           
    preprocess[0].pre_quality = NO; 
    preprocess[1].pre_quality = NO;
    preprocess[0].pre_quecc = NO;
    preprocess[1].pre_quecc = NO;
    preprocess[0].pre_delay_time = float(0.0);
    preprocess[1].pre_delay_time = float(0.0);        
    preprocess[0].pre_quecc_points = 0;                
    preprocess[1].pre_quecc_points = 0;
